  ...
  try {
    ...
    const users = userData.map((user) => {
      ...
      return {
        ...
        is_admin_managed: user.is_admin_managed ?? false,
        org_place_id: user.org_place_id ?? null,
        location_lat: user.location_lat ?? null,
        location_lng: user.location_lng ?? null,
        default_parking_coverage: user.default_parking_coverage ?? null,
        default_parking_instructions: user.default_parking_instructions ?? null,
        default_arrival_instructions: user.default_arrival_instructions ?? null,
        default_event_description: user.default_event_description ?? null,
        default_accessibility_notes: user.default_accessibility_notes ?? null,
        default_space_sqft: user.default_space_sqft ?? null,
        default_dogs_needed: user.default_dogs_needed ?? null,
        default_requires_vsc: user.default_requires_vsc ?? null,
